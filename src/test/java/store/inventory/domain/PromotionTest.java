...
class PromotionTest {
    ...
    @BeforeEach
    void setUp() {
        promotion = new Promotion("탄산 2+1", 2, 1, LocalDate.parse("2024-01-01"), LocalDate.parse("2024-12-31"));
    }
